...
export function VoiceSetupButton(): React.ReactElement | null {
  ...
  return (
    <button
      onClick={handleClick}
      className="flex w-full items-center gap-2 px-4 py-2 text-sm text-zinc-500 dark:text-zinc-400 transition-colors hover:bg-zinc-200/50 dark:hover:bg-zinc-200/50 dark:bg-zinc-800/50 hover:text-zinc-800 dark:text-zinc-200"
    >

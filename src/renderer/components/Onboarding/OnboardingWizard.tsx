...
function WelcomeStep({ onNext }: { onNext: () => void }): React.ReactElement {
  return (
    <div className="flex flex-col items-center text-center">
      <div className="mb-6 text-5xl font-bold tracking-tight text-zinc-100">
        Novel Engine
      </div>
...
function ClaudeSetupStep({ onNext }: { onNext: () => void }): React.ReactElement {
  ...
  return (
    <div className="flex flex-col items-center">
      <h2 className="mb-2 text-2xl font-bold text-zinc-100">Connect to Claude</h2>
      ...
      <div className="mb-6 w-full space-y-3 rounded-lg border border-zinc-700 bg-zinc-800/50 p-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-sm text-zinc-300">Install Claude Code CLI:</p>
            <code className="mt-1 block rounded bg-zinc-900 px-3 py-1.5 text-xs text-zinc-300">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-sm text-zinc-300">
              Authenticate: Run{' '}
              <code className="rounded bg-zinc-900 px-1.5 py-0.5 text-xs">claude login</code>{' '}
              in your terminal
            </p>
          </div>
        </div>
      ...
      <button
        ...
        className="mb-6 text-sm text-blue-400 underline decoration-blue-400/30 transition-colors hover:text-blue-300"
      >
      ...
      {(status === 'not-found' || status === 'idle') && (
          <button
            onClick={onNext}
            className="rounded-lg px-6 py-2.5 text-sm text-zinc-400 transition-colors hover:text-zinc-200"
          >
            Skip for now
          </button>
        )}
...
function ModelSelectStep({ onNext }: { onNext: (model: string) => void }): React.ReactElement {
  ...
  return (
    <div className="flex flex-col items-center">
      <h2 className="mb-2 text-2xl font-bold text-zinc-100">Choose Your Model</h2>
        ...
        {models.map((model) => (
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="text-base font-semibold text-zinc-100">{model.label}</span>
...
function ReadyStep({
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="mb-6 w-full space-y-2 rounded-lg border border-zinc-700 bg-zinc-800/50 p-4">
        <div className="flex items-center justify-between">
          <span className="text-sm text-zinc-400">Claude CLI</span>
        ...
        <div className="flex items-center justify-between">
          <span className="text-sm text-zinc-400">Author Profile</span>

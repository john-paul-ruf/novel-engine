...
| 02 | Codex CLI provider implementation | `M06`, `M08` | pending |  | Adds infrastructure provider that invokes local `codex` CLI. |
...
- Next eligible session: Session 02 — Codex CLI provider implementation.
